...
public class SMSUtils {
    /*发送短信验证码*/
    public static final String VALIDATE_CODE = "SMS_212480428";
    /*体检预约成功通知*/
    ...
    /*你的AccessKey ID*/
    private static final String ACCESS_KEY="LTAI4G7TAT9TabtaHzsshfKj";
    /*你的AccessKey Secret*/
    private static final String SECRET_KEY= "T4f5OjDfB0iuFh0fcgFC9Cp2sujsA1";
